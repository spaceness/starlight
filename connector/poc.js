...
console.log(`✨ [Starlight] Login to this machine with the following URL: https://starlight-client.surge.sh/vnc.html?host=nostr.grooveix.com&path=${sessionId}&port=443&encrypt=1&autoconnect=true`)
